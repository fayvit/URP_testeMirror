...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        /// </summary>
        public virtual void OnStartServer() { Debug.Log("chamada onStartServer"); }

        /// <summary>
        /// This is invoked when the client is started.
        /// </summary>
        public virtual void OnStartClient() { Debug.Log("chamada onStartClient"); }

        /// <summary>
        /// This is called when a server is stopped - including when a host is stopped.
        /// </summary>
        public virtual void OnStopServer() { Debug.Log("chamada onStopServer"); }

        /// <summary>
        /// This is called when a client is stopped.
        /// </summary>
        public virtual void OnStopClient() { Debug.Log("chamada onStopClient"); }

        /// <summary>
        /// This is called when a host is stopped.
        /// </summary>
        public virtual void OnStopHost() { Debug.Log("chamada onStopHost"); }
