...
public class SupportCreationUi : MonoBehaviour
{
    ...
    public static SupportCreationUi Instance
    {
        get
        {
            if (instance == null)
            {
                ...
                Debug.LogError("SupportCreationUI tem elementos que deveriam ser setados no inspector, " +
    ...
    /// </summary>
    public MenuReference CreateBasicMenu(float xStart,float yStart,float xEnd,float yEnd)
    {
